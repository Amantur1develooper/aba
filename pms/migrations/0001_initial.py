    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='company_folios', to='dds.point', verbose_name='Точка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='guests', to='dds.point', verbose_name='Точка')),
            ],
            options={
                'verbose_name': 'Гость',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='rooms', to='dds.point', verbose_name='Точка')),
            ],
            options={
                'verbose_name': 'Номер',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='stays', to='dds.point', verbose_name='Точка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Активен')),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='room_types', to='dds.point', verbose_name='Точка')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='room',
            name='room_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='rooms', to='pms.roomtype', verbose_name='Тип номера'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pms_settings', to='dds.point')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_type', models.CharField(blank=True, choices=[('charge', 'Начисление'), ('payment', 'Оплата'), ('adjust', 'Корректировка')], max_length=12, null=True, verbose_name='Тип')),
                ...
                ('signed_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Сумма (со знаком)')),
                ('stay_id', models.IntegerField(blank=True, null=True, verbose_name='ID проживания (если нужно)')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='folio_items_created', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='booking',
            name='company',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='bookings', to='pms.company', verbose_name='Компания'),
        ),
        migrations.AddField(
            model_name='booking',
            name='created_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bookings_created', to=settings.AUTH_USER_MODEL, verbose_name='Создал'),
        ),
        migrations.AddField(
            model_name='booking',
            name='hotel',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bookings', to='dds.point', verbose_name='Точка'),
        ),
        migrations.AddField(
            model_name='booking',
            name='room',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='pms.room', verbose_name='Номер'),
        ),
        migrations.AddField(
            model_name='booking',
            name='room_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='pms.roomtype', verbose_name='Тип номера'),
        ),
